...
public class Factory : Enemy
{
    ...
    {
        this.name = "Factory";
        this.attacks = new Attack[] { new Attack(1000, 7, "Sound the alarm"),
            new Attack(2000, 12, "Staff Evacuation"),
            new Attack(3000, 17, "Pollution Puke")};
...
public class Skyscraper : Enemy
{
    public Skyscraper()
    {
        ...
        this.attacks = new Attack[] { new Attack(1000, 2, "Spiky spiky"),
            new Attack(4000, 23, "Shuriken from the sky"),
            new Attack(5000, 47, "Snakescraper")};
...
public class Cathedral : Enemy
{
    ...
    {
        this.name = "Cathedral";
        this.attacks = new Attack[] { new Attack(1000, 2, "Belly Belly"),
            new Attack(4000, 27, "Sacrushed Chapel"),
